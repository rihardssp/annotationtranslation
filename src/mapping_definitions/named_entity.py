...
def person_chunk_action(pipe, root_id: str, chunk: typing.List[INamedEntitiesWord], container: IContainer,
                        default_mapping: str):
...
# ToDo: Use event type (look documentation)
def string_concat_chunk_action(pipe, root_id: str, chunk: typing.List[INamedEntitiesWord], container: IContainer,
                                           default_mapping: str):
...
def money_chunk_action(pipe, root_id: str, chunk: typing.List[INamedEntitiesWord], container: IContainer,
                                           default_mapping: str):
...
def concat_chunk_location_action(pipe, root_id: str, chunk: typing.List[INamedEntitiesWord],
    ...
    container.replace_parents_roles_to_instance(root_id, "mod", "location")
